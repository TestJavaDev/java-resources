...
nav_order: 8
permalink: /systemdesign/problems/youtube
---
<div align="center" markdown="1">
Designing Youtube or Netflix / Java resources / Tutorial
...
1. CDNs replicate content in multiple places. There’s a better chance of videos being closer to the user and, with fewer hops, videos will stream from a friendlier network.
2. CDN machines make heavy use of caching and can mostly serve videos out of memory.
3. Less popular videos (1-20 views per day) that are not cached by CDNs can be served by our servers in various data centers.
